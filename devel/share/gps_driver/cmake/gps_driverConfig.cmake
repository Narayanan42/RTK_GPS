...
if("TRUE" STREQUAL "TRUE")
  set(gps_driver_SOURCE_PREFIX /home/nanu/catkin_ws/src/gps_driver)
  set(gps_driver_DEVEL_PREFIX /home/nanu/catkin_ws/devel)
  ...
  set(gps_driver_INSTALL_PREFIX /home/nanu/catkin_ws/install)
...
if(NOT "/home/nanu/catkin_ws/devel/include " STREQUAL " ")
  set(gps_driver_INCLUDE_DIRS "")
  set(_include_dirs "/home/nanu/catkin_ws/devel/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'nanu <nanu@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gps_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nanu/catkin_ws/src/gps_driver/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nanu/catkin_ws/devel/lib;/opt/ros/noetic/lib)
